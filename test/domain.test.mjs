...
function base(overrides = {}) {
  return {
    ...
    theme: {
      ...
      accent: "#54d6c5", accent2: "#7da8ff", accent3: "#ffbf78", panel: "#132238",
    },
...
test("presenterProfile defaults to lina-tech-v1", () => {
  const parsed = parsePresentation(base());
  // default values come back as nested objects (Zod 4 keeps the .default()).
  assert.equal(parsed.presenterProfile.id, "lina-tech-v1");
});