...
def _tts_plan(args: argparse.Namespace) -> int:
    presentation_path = _path(args.presentation, "content/presentation.json")
    profile_path = _path(args.profile, "content/tts-profile.json")
...
def _node_check(args: argparse.Namespace) -> int:
    command = ["node", "scripts/validate-deck.mjs"]
